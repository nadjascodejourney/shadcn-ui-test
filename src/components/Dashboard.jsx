"use client"; // this means that this component will be rendered on the client side only
import {
  Area,
  AreaChart,
  Bar,
          ...
          <CardContent>
            <ChartContainer
              config={{
                steps: {
                  label: "Steps",
                  /*  color: "hsl(200, 100%, 50%)", */ // this is the same as the color below wihtin the fill property of the bar chart elements
                },
              }}
            >
              <BarChart
                accessibilityLayer // this adds a hidden layer to the chart for screen readers
                margin={{
                  left: -4,
                  right: -4,
                }}
              ...
              >
                <Bar
                  ...
                  radius={5}
                  fillOpacity={0.6}
                  activeBar={<Rectangle fillOpacity={2} />}
                />
                <XAxis
                  dataKey="date"
                  tickLine={false}
